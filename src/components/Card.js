...
const Card = (props) => {
  return (
    <section id='card-section' className="text-gray-600 body-font flex flex-row">
        ...
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3">
             Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iste magnam nisi vitae omnis iure dolor.
            </p>
